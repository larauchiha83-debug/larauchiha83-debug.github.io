...
function atualizarVitrine(){
  ...
  produtos.forEach(p=>{
    ...
    adicionarBotaoDenuncia(div,p.nome); // botão de denúncia integrado
  });
}
...
document.getElementById("marketBtn").addEventListener("click", mostrarMarketplace);// Função para criar botão de denúncia em qualquer card ou item
